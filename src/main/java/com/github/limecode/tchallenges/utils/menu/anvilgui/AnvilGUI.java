package com.github.limecode.tchallenges.utils.menu.anvilgui;
...
public class AnvilGUI {
    private AnvilWrapperAnvilGui WRAPPER = new AnvilWrapperAnvilGui();
    private final TChallenges plugin;
    ...
    @Deprecated
    public AnvilGUI(TChallenges plugin, Player holder, String insert, BiFunction<Player, String, String> biFunction) {
    ...
    public static class Builder {
        ...
        public Builder plugin(TChallenges plugin) {
